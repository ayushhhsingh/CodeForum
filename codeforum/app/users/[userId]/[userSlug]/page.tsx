...
const Page = async ({
  ...
  try {
    ...
    const message = isPausedProjectError(error)
      ? "This Appwrite project is paused. Restore it from the Appwrite console to see profile statistics again."
      : getAppwriteErrorMessage(error);

    return (
      <div className="rounded-2xl border border-amber-500/40 bg-amber-500/10 p-6">
        <h2 className="text-xl font-semibold">Profile Stats Unavailable</h2>
